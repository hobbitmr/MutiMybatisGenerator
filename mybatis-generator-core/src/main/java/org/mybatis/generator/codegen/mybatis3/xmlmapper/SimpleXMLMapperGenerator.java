...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertNotCheckElementGenerator;
...
public class SimpleXMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addInsertElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateInsertNotCheck()) {
            AbstractXmlElementGenerator elementGenerator = new InsertNotCheckElementGenerator(true);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
