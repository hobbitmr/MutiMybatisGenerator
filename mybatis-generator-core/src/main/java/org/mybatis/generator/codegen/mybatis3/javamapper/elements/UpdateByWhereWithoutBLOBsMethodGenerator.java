 ...
 * 
 */
public class UpdateByWhereWithoutBLOBsMethodGenerator extends
        AbstractJavaMapperMethodGenerator {

    public UpdateByWhereWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getUpdateByWhereStatementId());
