...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addDeleteByWhereMethod(interfaze);
        addDeleteByPrimaryKeyMethod(interfaze);

        addInsertNotCheckMethod(interfaze);
        addInsertMethod(interfaze);
        addInsertsMethod(interfaze);

        addUpdateByWhereSelectiveMethod(interfaze);
        addUpdateByWhereWithBLOBsMethod(interfaze);
        addUpdateByWhereWithoutBLOBsMethod(interfaze);
    ...
    protected void addDeleteByWhereMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateDeleteByWhere()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new DeleteByWhereMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addInsertNotCheckMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateInsertNotCheck()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new InsertNotCheckMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addInsertsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateInserts()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new InsertsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addSelectByWhereWithoutBLOBsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByWhereWithoutBLOBs()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByWhereWithoutBLOBsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addUpdateByWhereWithBLOBsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUpdateByExampleWithBLOBs()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateByWhereWithBLOBsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }

    protected void addUpdateByWhereWithoutBLOBsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUpdateByWhereWithoutBLOBs()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateByWhereWithoutBLOBsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addUpdateByPrimaryKeySelectiveMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUpdateByPrimaryKeySelective()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateByPrimaryKeyMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
