...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.InsertNotCheckMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectListByWhereMethodGenerator;
...
public class SimpleJavaClientGenerator extends AbstractJavaClientGenerator {
    ...
    protected void addInsertMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateInsertNotCheck()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new InsertNotCheckMethodGenerator(true);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addSelectAllMethod(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new SelectListByWhereMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
