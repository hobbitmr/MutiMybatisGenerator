...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        createClassRemark(topLevelClass,introspectedTable.getRemarks());
    }
    ...
    public void addFieldComment(Field field,
        ...
        createRemark(field,introspectedColumn.getRemarks());
    }
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
        ...
        createRemark(field,introspectedTable.getRemarks());
    }
    /* (non-Javadoc)
   * @see org.mybatis.generator.api.CommentGenerator#addFieldComment(org.mybatis.generator.api.dom.java.Field, org.mybatis.generator.api.IntrospectedTable)
   */
    public void addFieldComment(Field field, String remark) {
        if (suppressAllComments) {
            return;
        }
        createRemark(field,remark);
    }

    @Override
    public void addGeneralMethodComment(Method method, String remark) {
        if (suppressAllComments) {
            return;
        }
        createRemark(method,remark);
    }
    ...
    public void addGetterComment(Method method,
        ...
        createRemark(method,introspectedColumn.getRemarks());
    }

    private void createRemark(JavaElement method,String remark){
        StringBuilder sb = new StringBuilder();
        method.addJavaDocLine("/**");
        if(remark==null){
            remark="";
        }
        List<String> remarkSpliteList = new ArrayList<String>();
        int javadocLenght=50;
        int startIndex=0;
        while(remark.length()>javadocLenght){
            remarkSpliteList.add(remark.substring(startIndex,javadocLenght));
            remark=remark.substring(javadocLenght,remark.length());
        }
        remarkSpliteList.add(remark);
        for(String text:remarkSpliteList){
            method.addJavaDocLine(" *"+text);
        }
        method.addJavaDocLine(" */");
    }
     ...
     * @param remark
     */
    private void createClassRemark(JavaElement method,String remark){

        StringBuilder sb = new StringBuilder();
        method.addJavaDocLine("/**");
        method.addJavaDocLine(" *说明:"+remark);
        addJavadocTag(method, false);
        method.addJavaDocLine(" */");
    }
    /* (non-Javadoc)
    ...
    @Override
    public void addClassComment(InnerClass innerClass, String remark) {

        createClassRemark(innerClass,remark);
    }
