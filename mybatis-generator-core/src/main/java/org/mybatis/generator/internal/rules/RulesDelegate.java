 ...
 *     boolean rc = super.generateInsertNotCheck();
 *     if (rc) {
...
public class RulesDelegate implements Rules {
    ...
    public boolean generateDeleteByWhere() {
        return rules.generateDeleteByWhere();
    }
    ...
    public boolean generateInsertNotCheck() {
        return rules.generateInsertNotCheck();
    }
    ...
    public boolean generateSelectByWhereWithoutBLOBs() {
        return rules.generateSelectByWhereWithoutBLOBs();
    }
    ...
    public boolean generateUpdateByWhereWithoutBLOBs() {
        return rules.generateUpdateByWhereWithoutBLOBs();
    }
